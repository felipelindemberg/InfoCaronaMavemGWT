...
public class SistemaUsuarioNaoLogado {
	...
	private Id id;
	public static SistemaUsuarioNaoLogado instance;
	
	protected SistemaUsuarioNaoLogado(){
		controler = new ControlerRepositorio();
		id = Id.getInstance(5);
	}
	
	public static SistemaUsuarioNaoLogado getInstace(){
		if(instance == null){
			instance = new SistemaUsuarioNaoLogado();
		}
