...
public class SistemaRaiz {
	...
	public static SistemaRaiz instance;
	...
	public static Usuario procuraUsuarioLogado(String idSessao)
	...
	public String procuraIdSessao(String login){
		Collection<String> chaves = usuariosLogados.keySet();
		String retorno = null;
		
		for (String chave : chaves) {
			if(usuariosLogados.get(chave).getLogin().equals(login)){
				retorno = chave;
			}
		}
