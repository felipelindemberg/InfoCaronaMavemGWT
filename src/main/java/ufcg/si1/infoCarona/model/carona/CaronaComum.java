...
public class CaronaComum extends CaronaAbstract{
	...
	public TiposCarona getTipoCarona(){
		return TiposCarona.COMUM;
	}

	public Calendar getVolta() throws CaronaException {
		throw new CaronaException("A carona comum não existe volta");
	}

	public double getGasolina() throws CaronaException {
		throw new CaronaException("A carona comum não existe gasolina");
	}

	public int getMinimoCaroneiros() throws CaronaException {
		throw new CaronaException("A carona comum não existe minimo de caroneiros");
	}
}
